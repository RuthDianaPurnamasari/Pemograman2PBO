...
{
    class ProductTest_714220042
    {
        static void Main(string[] args)
        {
            Book_714220042 product1 = new Book_714220042("Book", "C# Object Oriented Solution", "300");
            DVD_714220042 product2 = new DVD_714220042("Ethernal Sunshin Of The Spotless Mind", "145");
